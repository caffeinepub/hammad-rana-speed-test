...
const ENGLISH_PASSAGES = {
  ...
  normal: "Typing speed is a valuable skill that improves with consistent daily practice and focus.",
...
function App() {
  const [language, setLanguage] = reactExports.useState("urdu");
  ...
  const difficultyLabels = isUrdu ? URDU_DIFFICULTY_LABELS : ENGLISH_DIFFICULTY_LABELS;
  const passage = passages[difficulty];
  const wpm = elapsed === 0 ? 0 : Math.round(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h1",
      {
        className: `text-4xl font-bold text-foreground ${isUrdu ? "urdu-text" : "english-text"}`,
        style: {
          fontSize: "clamp(1.4rem, 4vw, 2.2rem)",
          lineHeight: isUrdu ? 2 : 1.3
        },
        children: isUrdu ? "حماد رانا رائٹنگ اسپیڈ ٹیسٹنگ" : "Hammad Rana Writing Speed Testing"
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-2 mb-5 px-4", children: ["urdu", "english"].map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        "data-ocid": `language.${lang}.tab`,
        onClick: () => handleLanguageChange(lang),
        className: `px-7 py-2 rounded-full text-sm font-semibold transition-all duration-200 border ${language === lang ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-muted-foreground border-border hover:border-primary/50"}`,
        style: {
          fontFamily: lang === "urdu" ? "'Noto Nastaliq Urdu', serif" : "inherit"
        },
        children: lang === "urdu" ? "اردو" : "English"
      },
      lang
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        dir: isUrdu ? "rtl" : "ltr",
        children: ["easy", "normal", "hard"].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": `difficulty.${d}.toggle`,
            onClick: () => handleDifficultyChange(d),
            className: `px-6 py-2 rounded-full text-base font-medium transition-all duration-200 border ${difficulty === d ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-muted-foreground border-border hover:border-primary/50"} ${isUrdu ? "urdu-text" : "english-text"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 pb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: isUrdu ? "urdu-text text-foreground" : "english-text text-foreground",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-xl border border-border shadow-xs p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                ref: textareaRef,
                ...
                placeholder: isUrdu ? "یہاں ٹائپ کریں..." : "Start typing here...",
                className: `w-full resize-none rounded-lg p-4 text-base text-foreground placeholder:text-muted-foreground outline-none transition-all ${isUrdu ? "urdu-text" : "english-text"}`,
                style: {
                  height: "200px",
                  border: isRunning ? "2px solid oklch(var(--primary))" : "2px solid oklch(var(--border))",
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `font-semibold text-primary ${isUrdu ? "urdu-text" : "english-text"}`,
                      style: { fontSize: "1.1rem", lineHeight: isUrdu ? 2 : 1.6 },
                      children: isUrdu ? "🎉 شاباش! آپ نے ٹیسٹ مکمل کر لیا!" : "🎉 Well done! Test completed!"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-muted-foreground mt-1 ${isUrdu ? "urdu-text" : "english-text"}`,
                      style: { fontSize: "0.9rem", lineHeight: isUrdu ? 2 : 1.6 },
                      children: isUrdu ? `وقت: ${elapsed} سیکنڈ | رفتار: ${wpm} WPM` : `Time: ${elapsed} sec | Speed: ${wpm} WPM`
                    }
                  )
                ]
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:w-72 flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border shadow-xs p-6 flex flex-col gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: `font-semibold text-center border-b border-border pb-3 text-foreground ${isUrdu ? "urdu-text" : "english-text"}`,
                  style: { fontSize: "1.1rem", lineHeight: isUrdu ? 2 : 1.5 },
                  children: isUrdu ? "نتائج" : "Results"
                }
              ),
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-muted-foreground ${isUrdu ? "urdu-text" : "english-text text-sm"}`,
                        style: { lineHeight: isUrdu ? 2 : 1.5 },
                        children: isUrdu ? "وقت (سیکنڈ)" : "Time (sec)"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-muted-foreground ${isUrdu ? "urdu-text" : "english-text text-sm"}`,
                        style: { lineHeight: isUrdu ? 2 : 1.5 },
                        children: isUrdu ? "الفاظ فی منٹ" : "Words per Minute"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-muted-foreground ${isUrdu ? "urdu-text" : "english-text text-sm"}`,
                        style: { lineHeight: isUrdu ? 2 : 1.5 },
                        children: isUrdu ? "حالت" : "Status"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-sm font-medium px-3 py-1 rounded-full ${isFinished ? "bg-accent text-primary" : isRunning ? "bg-accent text-primary" : "bg-secondary text-muted-foreground"} ${isUrdu ? "urdu-text" : "english-text"}`,
                        style: { lineHeight: isUrdu ? 2 : 1.5 },
                        children: isUrdu ? isFinished ? "مکمل" : isRunning ? "جاری" : "بند" : isFinished ? "Finished" : isRunning ? "Running" : "Idle"
                      }
                    )
                  ]
                }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-full py-3 px-6 rounded-lg text-primary-foreground font-semibold transition-all duration-200 ${isUrdu ? "urdu-text" : "english-text"}`,
                  style: {
                    background: isRunning || isFinished ? "oklch(0.75 0.08 245)" : "oklch(var(--primary))",
                    cursor: isRunning || isFinished ? "not-allowed" : "pointer",
                    fontSize: "1rem",
                    lineHeight: isUrdu ? 2 : 1.5
                  },
                  children: isUrdu ? "شروع کریں" : "Start"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: handleReset,
                  className: `w-full py-3 px-6 rounded-lg font-semibold transition-all duration-200 hover:brightness-95 ${isUrdu ? "urdu-text" : "english-text"}`,
                  style: {
                  ...
                  children: isUrdu ? "دوبارہ شروع" : "Reset"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-muted-foreground text-center ${isUrdu ? "urdu-text" : "english-text text-sm"}`,
                      style: { lineHeight: isUrdu ? 2 : 1.5 },
                      children: isUrdu ? "موجودہ درجہ:" : "Current Level:"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-primary font-semibold text-center ${isUrdu ? "urdu-text" : "english-text"}`,
